...
//        HERO.SCORE ++;
        ...
        if (isUP) {
            if (App.objectCollisionDetectWithHero().equals("good-way") || isDOWN || isRIGHT || isLEFT){
        ...
        if (isRIGHT) {
            if (App.objectCollisionDetectWithHero().equals("good-way")) {

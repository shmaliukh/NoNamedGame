...
public class HeroSoundService {
    ...
    public static MediaPlayer heroMediaPlayer = new MediaPlayer(new Media(new File("src/main/resources/hero_frazes/eat/monetyi-vyisyipayut.mp3").toURI().toString()));
